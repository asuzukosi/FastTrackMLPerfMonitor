...
# experiment = tracking_client.create_experiment("first-experiment")
# print(experiment)

experiment = tracking_client.get_experiment_by_name("first-experiment")

run = tracking_client.create_run(experiment.experiment_id)
